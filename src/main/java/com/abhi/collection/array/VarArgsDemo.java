package com.abhi.collection.array;
...
public class VarArgsDemo {
	...
	public static void main(String[] args) {
		...
		varArgsDemo.print(new String[] {"abhi"});
		varArgsDemo.print(new String[] {"abhi", "kumar"});
		varArgsDemo.print(new String[] {"abhi", "kumar", "singh"});
